...
const Cart = ({ cart }) => {
    ...
    const FilledCart = () => (
        <>
            ...
            <Typography varaint="h5">subtitle:{cart.subtotal.formatted_with_symbol}</Typography>
            <div>
    ...
    return (
        <Container>
            ...
            <Typography className={classes.title} varaint="h5">Your Shopping Cart</Typography>
